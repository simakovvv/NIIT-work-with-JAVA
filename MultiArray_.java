...
public class MultiArray_ {// *Given a square matrix, the size is entered by the user. Find the sum of the
							// elements of each of the diagonals without using nested loops
	int side_length;
	int matrixA[][];
	int summ;
	int buf;
	...
	public static void main(String[] args) {
		MultiArray_ myMultiArray = new MultiArray_();
		...
		System.out.println(
				"The sum of the numbers of the direct and inverse diagonals of the array:" + myMultiArray.summ);
